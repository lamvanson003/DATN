                                ...
                                <div id="variantForms">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12 col-sm-12 d-flex mb-3">
                                                <div class="me-2 flex-grow-1">
                                                    <label for="price1" class="form-label formatPrice">Giá <span style="color: red">*</span>:</label>
                                                    <input type="text" required class="form-control" name="variants[0][price]" id="price1" placeholder="Nhập giá" min="1000">
                                                </div>
                        
                                                <div class="me-2 flex-grow-1">
                                                    <label for="sale1" class="form-label formatPrice">Khuyến mãi <span style="color: red">*</span>:</label>
        ...
        const variantForm = `
            <div class="card mb-4" id="variant${variantCount}">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12 col-sm-12 d-flex mb-3">
                        <div class="me-2 flex-grow-1">
                            <label for="price${variantCount}" class="form-label formatPrice">Giá <span style="color: red">*</span>:</label>
                        ...
                        <div class="me-2 flex-grow-1">
                            <label for="sale${variantCount}" class="form-label formatPrice">Khuyến mãi:</label>
