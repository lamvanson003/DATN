                            ...
                            <div class="row card-body">
                                ...
                                <div class="col-md-12 col-sm-12 d-flex gap-2">
                                    <div class="mb-3 col-5">
                                        ...
                                        <input type="text" class="required form-control" id="title" name="name" value="{{ $category->name }}" placeholder="VD: Điện thoại">
                                    </div>
                                    <div class="mb-3 col-5">
                                        <label class="control-label">Đường dẫn<span style="color: red">*</span>:</label>
                                        <input type="text" class="required form-control" id="slug" name="slug" value="{{ $category->slug }}" placeholder="VD: dien-thoai">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
