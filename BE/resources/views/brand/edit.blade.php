                    ...
                    <div class="col-12 col-md-9">
                        <div class="card">
                            <div class="card-header justify-content-center">
                                <h3 class="mb-0 strong text-center">Chỉnh sửa thương hiệu</h3>
                            </div>
                            <div class="row card-body">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" required class="form-control text-capitalize" name="name" value="{{ $brand->name }}" placeholder="VD: Iphone 13promax">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12">
                                    <div class="mb-3">
                                        <label class="control-label">Đường dẫn<span style="color: red">*</span>:</label>
                                        <input type="text" required class="form-control text-capitalize" name="slug" value="{{ $brand->slug }}" placeholder="VD: Iphone 13promax">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-3">
                            ...
                            <div class="card-body p-2">
                                <select class="form-select" name="status">
                                    @foreach ($status as $key => $value)
                                        <option {{ $key == $brand->status->value ? 'selected' : '' }} value="{{ $key }}">{{ $value }}</option>
                                    @endforeach
                                </select>                                
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body p-2">
                                ...
                                <input type="hidden" name="old_image" value="{{ $brand->images }}">
                                <div class="image-container" style="cursor: pointer;">
                                    <!-- Hình ảnh đại diện ban đầu -->
                                    <img id="imagePreview" 
                                         src="{{ asset($brand->images ?? 'images/default-image.png') }}" 
                            ...
                            document.addEventListener('DOMContentLoaded', function() {
                                function loadFile(event) {
                                    ...
                                    if (file) {
                                        ...
                                        imagePreview.src = "{{ asset($brand->images ?? 'images/default-image.png') }}";
                                    }
                                }
