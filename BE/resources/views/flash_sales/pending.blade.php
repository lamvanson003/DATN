                      ...
                      <td>
                        @switch($item->is_active->value)
                            @case(\App\Enums\Status::Active)
                                <span class="badge rounded-pill badge-success">{{ \App\Enums\Status::getDescription($item->is_active->value) }}</span>
                            @break
                            @case(\App\Enums\Status::Inactive)
                                <span class="badge rounded-pill badge-warning">{{ \App\Enums\Status::getDescription($item->is_active->value) }}</span>
                            @break
                            @default
