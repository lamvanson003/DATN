                      ...
                      <table id="add-row" class="display table table-hover fix_table">
                        ...
                        <tbody>
                          @foreach ($product_image_item as $item)
                            ...
                            <!-- Modal Xóa sản phẩm -->
                            {{-- <div class="modal fade" id="deleteMyModal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleMyModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleMyModalLabel">Thông báo</h1>
