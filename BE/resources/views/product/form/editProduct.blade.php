    ...
    <div class="card-body">
        ...
        <div class="col-md-12 col-sm-12 d-flex mb-3">
            <div class="me-2 flex-grow-1">
                ...
                <input type="text" required class="form-control" id="title" name="name" value="{{ $product->name }}" placeholder="VD: Iphone 13 Pro Max">
            </div>
            <div class="flex-grow-1">
                <label class="control-label">Đường dẫn<span style="color: red">*</span>:</label>
                <input type="text" required class="form-control" id="slug" name="slug" value="{{ $product->slug }}" placeholder="VD: iphone-13-promax">
            </div>
        </div>
       <!-- Category ID and Brand ID in the same row -->
        ...
        <div class="col-md-12 col-sm-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" name="description" rows="5" placeholder="Mô tả chi tiết về sản phẩm" >{{ $product->description }}
                </textarea>
            </div>
        </div>
